...
public class BerserkrLogger extends LegacyAbstractLogger {
    ...
    public static final String CACHE_OUTPUT_STREAM_STRING_KEY = BerserkrLogger.SYSTEM_PREFIX + "cacheOutputStream";

    public static final String WARN_LEVEL_STRING_KEY = BerserkrLogger.SYSTEM_PREFIX + "warnLevelString";

    public static final String LEVEL_IN_BRACKETS_KEY = BerserkrLogger.SYSTEM_PREFIX + "levelInBrackets";

    public static final String LOG_FILE_KEY = BerserkrLogger.SYSTEM_PREFIX + "logFile";

    public static final String SHOW_SHORT_LOG_NAME_KEY = BerserkrLogger.SYSTEM_PREFIX + "showShortLogName";

    public static final String SHOW_LOG_NAME_KEY = BerserkrLogger.SYSTEM_PREFIX + "showLogName";

    public static final String SHOW_THREAD_NAME_KEY = BerserkrLogger.SYSTEM_PREFIX + "showThreadName";

    public static final String SHOW_THREAD_ID_KEY = BerserkrLogger.SYSTEM_PREFIX + "showThreadId";

    public static final String DATE_TIME_FORMAT_KEY = BerserkrLogger.SYSTEM_PREFIX + "dateTimeFormat";
    ...
    protected BerserkrLogger(String name) {
        ...
        if (levelString != null) {
            this.currentLogLevel = BerserkrLoggerConfiguration.stringToLevel(levelString);
        } else {
    ...
    String recursivelyComputeLevelString() {
        ...
        while ((levelString == null) && (indexOfLastDot > -1)) {
            ...
            levelString = CONFIG_PARAMS.getStringProperty(BerserkrLogger.LOG_KEY_PREFIX + tempName, null);
